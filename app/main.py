...
class OPTIONSHandlerMiddleware(BaseHTTPMiddleware):
    async def dispatch(self, request: Request, call_next):
        ...
        if request.method == "OPTIONS":
            ...
            origin_allowed = (normalized_origin and (normalized_origin in allowed_origins or origin in allowed_origins))
        ...
        if origin:
            ...
            origin_allowed = normalized_origin in allowed_origins or origin in allowed_origins
